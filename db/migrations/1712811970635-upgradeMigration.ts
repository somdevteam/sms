...
export class UpgradeMigration1712811970635 implements MigrationInterface {
    name = 'UpgradeMigration1712811970635'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`academics\` (\`academicId\` int NOT NULL AUTO_INCREMENT, \`academicYear\` varchar(255) NOT NULL, \`dateCreated\` datetime NOT NULL, \`isActive\` tinyint NOT NULL DEFAULT 0, PRIMARY KEY (\`academicId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`academic_branch\` (\`academicBranchId\` int NOT NULL AUTO_INCREMENT, \`isActive\` tinyint NOT NULL DEFAULT 1, \`academicId\` int NULL, \`branchId\` int NULL, PRIMARY KEY (\`academicBranchId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`class_section\` (\`classSectionId\` int NOT NULL AUTO_INCREMENT, \`dateCreated\` datetime NOT NULL, \`classId\` int NULL, \`sectionId\` int NULL, \`branchAcademicId\` int NULL, PRIMARY KEY (\`classSectionId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`level\` (\`levelid\` int NOT NULL AUTO_INCREMENT, \`levelname\` varchar(255) NOT NULL, \`levelFee\` int NOT NULL, \`datecreated\` datetime NOT NULL, \`isactive\` tinyint NOT NULL DEFAULT 1, PRIMARY KEY (\`levelid\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`branch\` (\`branchId\` int NOT NULL AUTO_INCREMENT, \`branchName\` varchar(255) NOT NULL, \`branchLocation\` varchar(255) NOT NULL, \`branchLogo\` varchar(255) NULL, \`coverLogo\` varchar(255) NULL, \`dateCreated\` datetime NOT NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_f5ca0154017181a87b4e8401f9\` (\`branchName\`), PRIMARY KEY (\`branchId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`userroles\` (\`userRoleId\` int NOT NULL AUTO_INCREMENT, \`userId\` int NULL, \`roleId\` int NULL, UNIQUE INDEX \`REL_93ff56f9d18997faacbeea7253\` (\`userId\`), PRIMARY KEY (\`userRoleId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`academic_branch\` ADD CONSTRAINT \`FK_3fb3f5ade49ca87a9515fc58720\` FOREIGN KEY (\`academicId\`) REFERENCES \`academics\`(\`academicId\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`academic_branch\` ADD CONSTRAINT \`FK_f2db25363301d9a4caf1e73bd8e\` FOREIGN KEY (\`branchId\`) REFERENCES \`branch\`(\`branchId\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`class_section\` ADD CONSTRAINT \`FK_c3e32b52827e62ddde6c3b7b9d6\` FOREIGN KEY (\`classId\`) REFERENCES \`class\`(\`classid\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`class_section\` ADD CONSTRAINT \`FK_c46cc166cdd1d9cc214f610ffda\` FOREIGN KEY (\`sectionId\`) REFERENCES \`section\`(\`sectionid\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`class_section\` ADD CONSTRAINT \`FK_28e3c093ec1e130a406a7bbf665\` FOREIGN KEY (\`branchAcademicId\`) REFERENCES \`academic_branch\`(\`academicBranchId\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`class_section\` DROP FOREIGN KEY \`FK_28e3c093ec1e130a406a7bbf665\``);
        await queryRunner.query(`ALTER TABLE \`class_section\` DROP FOREIGN KEY \`FK_c46cc166cdd1d9cc214f610ffda\``);
        await queryRunner.query(`ALTER TABLE \`class_section\` DROP FOREIGN KEY \`FK_c3e32b52827e62ddde6c3b7b9d6\``);
        await queryRunner.query(`ALTER TABLE \`academic_branch\` DROP FOREIGN KEY \`FK_f2db25363301d9a4caf1e73bd8e\``);
        await queryRunner.query(`ALTER TABLE \`academic_branch\` DROP FOREIGN KEY \`FK_3fb3f5ade49ca87a9515fc58720\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_93ff56f9d18997faacbeea7253\` ON \`userroles\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_f5ca0154017181a87b4e8401f9\` ON \`branch\``);
        ...
        await queryRunner.query(`DROP TABLE \`academic_branch\``);
